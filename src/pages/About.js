    ...
    render () {
      return (
        ...
        <div className="About Me">
            ...
            <img src="https://danielarisa.com/wp-content/uploads/2022/10/logo-color.svg" width="1000" position="center" height="300" alt="logo" />
            <h1>About Us</h1>
            <p><Typical wrapper="span" steps={text} loop={Infinity} className={'caca'} /></p>
